...
const modes = {
  ...
  bbPFDPCcolors1line: {
    ATARI_WIDTH: 32,
    ATARI_MAXHEIGHT: 176,
    ATARI_STARTHEIGHT: 176,
    SCREEN_WIDTH_PER: 16,
    SCREEN_HEIGHT_PER: 2,
    MULTICOLOR: true,
    MULTICOLORBG: true,
    DOWNLOADS: {
      "bas": { file: "abbPFbBDPC.bas", action: (file) => { download(file, codeBBpfDPC(255, 255, '176 rows that are 1 scanline high.')); } }
    },
    NAME: 'bB DPC+ color PF (1 scanline)',
    DESCRIPTION: 'DPC+ / batari Basic code - 176 rows that are 1 scanline high - utilizes custom cartridge hardware for fine, wide pixels, per-scanline colors for playfield AND per-scanline colors for background.'
  },
  ...
  bbPFDPCcolors2line: {
    ...
    MULTICOLORBG: true,
    DOWNLOADS: {
      "bas": { file: "abbPFbBDPC.bas", action: (file) => { download(file, codeBBpfDPC(128, 255, '88 rows that are 2 scanlines high.')); } }
    },
    NAME: 'bB DPC+ color PF (2 scanline)',
    DESCRIPTION: 'DPC+ / batari Basic code - 88 rows that are 2 scanlines high - utilizes custom cartridge hardware for fine, wide pixels, per-scanline colors for playfield AND per-scanline colors for background.'
  },
  ...
  bbPFDPCcolors4line: {
    ...
    MULTICOLORBG: true,
    DOWNLOADS: {
      "bas": { file: "abbPFbBDPC.bas", action: (file) => { download(file, codeBBpfDPC(64, 128, '44 rows that are 4 scanlines high.')); } }
    },
    NAME: 'bB DPC+ color PF (4 scanline)',
    DESCRIPTION: 'DPC+ / batari Basic code - 44 rows that are 4 scanlines high - utilizes custom cartridge hardware for fine, wide pixels, per-scanline colors for playfield AND per-scanline colors for background.'
  },

  bbPFDPCcolors8line: {
    ATARI_WIDTH: 32,
    ATARI_MAXHEIGHT: 22,
    ATARI_STARTHEIGHT: 22,
    SCREEN_WIDTH_PER: 16,
    SCREEN_HEIGHT_PER: 16,
    MULTICOLOR: true,
    MULTICOLORBG: true,
    DOWNLOADS: {
      "bas": { file: "abbPFbBDPC.bas", action: (file) => { download(file, codeBBpfDPC(32, 64, '22 rows that are 8 scanlines high.')); } }
    },
    NAME: 'bB DPC+ color PF (8 scanline)',
    DESCRIPTION: 'DPC+ / batari Basic code - 22 rows that are 8 scanlines high - utilizes custom cartridge hardware for fine, wide pixels, per-scanline colors for playfield AND per-scanline colors for background.'
  },
  ...
  bbPFDPCcolors16line: {
    ...
    MULTICOLORBG: true,
    DOWNLOADS: {
      "bas": { file: "abbPFbBDPC.bas", action: (file) => { download(file, codeBBpfDPC(16, 32, '11 rows that are 16 scanlines high.')); } }
    },
    NAME: 'bB DPC+ color PF (16 scanline)',
    DESCRIPTION: 'DPC+ / batari Basic code - 11 rows that are 16 scanlines high - utilizes custom cartridge hardware for fine, wide pixels, per-scanline colors for playfield AND per-scanline colors for background.'
  },
  ...
  bbPFDPCcolors32line: {
    ...
    ATARI_STARTHEIGHT: 6,
    SCREEN_WIDTH_PER: 16,
    SCREEN_HEIGHT_PER: 64,
    MULTICOLOR: true,
    MULTICOLORBG: true,
    DOWNLOADS: {
      "bas": { file: "abbPFbBDPC.bas", action: (file) => { download(file, codeBBpfDPC(8, 16, '6 rows that are 32 scanlines high.')); } }
    },
    NAME: 'bB DPC+ color PF (32 scanline)',
    DESCRIPTION: 'DPC+ / batari Basic code - 6 rows that are 32 scanlines high - utilizes custom cartridge hardware for fine, wide pixels, per-scanline colors for playfield AND per-scanline colors for background.'
  },
